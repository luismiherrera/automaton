...
//Last modified: Sat, Aug 24, 2019 12:54:52 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.89415055570770063 0.39477829082411153 2.3811555221243994 ;
	setAttr ".r" -type "double3" -2.1383527294767637 -373.79999999974251 5.1173321677447956e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "7AAA6841-4C09-5833-F9E9-F7B1A9421867";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".ncp" 0.001;
	setAttr ".coi" 2.5529460620382696;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" -0.027576048476032646 0.20750343822219008 1000.1074369076086 ;
...
createNode camera -n "leftShape" -p "left";
	...
	setAttr ".ow" 0.86870035701362636;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A7605B29-4466-E03E-F4E7-14A390660A15";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3C84FDF4-4D26-6BF3-5B93-D2B8F2A04FE3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "92050CA2-40BA-6F55-11EA-E78D4616F31D";
createNode displayLayerManager -n "layerManager";
	rename -uid "F3B361A2-4B5A-FBCE-5462-4FA0227FC464";
createNode displayLayer -n "defaultLayer";
	rename -uid "A9E7D67A-43C4-94EE-C24C-79A9A22B955B";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "37E40F67-4A12-6A3B-B1CC-B68BF01478CB";
...
createNode animCurveTA -n "DOF_01_Ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  30 23.567420314517992 65 33.714094333662189
		 80 49.219998356305105 100 77.466827994744207 145 108.45571868080069 219 117.71928243131941;
createNode animCurveTA -n "DOF_02_Ctrl_rotateZ";
	rename -uid "FC46CFCA-4C8E-60C0-99FC-7685A7C3A3C3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  30 -15.786787568426144 80 -50.243679544880592
...
createNode animCurveTA -n "DOF_03_Ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  30 -66.021253308855236 65 -38.784754148180113
		 80 -7.719911783085772 100 -0.67534378701863673 145 -9.7290123949164169 175 -9.7290123949164169
		 200 -55.28843023900626;
createNode animCurveTA -n "DOF_04_Ctrl_rotateX";
	rename -uid "28DB709E-48C1-479B-2537-B69DA614DB7B";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  30 11.826418487149997 80 10.632149994412265
		 145 -107.25332293956302 200 -66.606546436114286 219 -54.467113682408993;
createNode animCurveTA -n "DOF_05_Ctrl_rotateZ";
	rename -uid "A4EB9708-4DED-F996-7D3E-DDA088DA79C6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  30 -42.315798233407868 61 -62.018686639490078
		 80 19.364094005844052 93 30.188291937414249 145 49.920747170478464 176 8.1749554972938672
		 200 -44.311980498365784 219 -86.634800525860527;
createNode animCurveTA -n "DOF_06_Ctrl_rotateY";
	rename -uid "A276D6A9-46C8-CD25-DCA0-F9BA31B555B4";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  30 -78.074785288601177 61 -46.868013962902097
		 80 50.863084745900487 93 75.401821628364189 145 81.032087793134068 176 75.374575447627635
		 200 61.172414285879974 219 22.024681685755692;
