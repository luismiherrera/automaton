...
//Name: simple_model_rigged_2nd_anim_test_02.ma
//Last modified: Sun, Aug 18, 2019 03:59:26 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.29288075356310989 0.43203692647011388 0.71126005838038764 ;
	setAttr ".r" -type "double3" -22.538352729805919 -385.3999999998677 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "7AAA6841-4C09-5833-F9E9-F7B1A9421867";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".ncp" 0.001;
	setAttr ".coi" 0.72764735651178458;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" 0.014075386388032575 0.15376976432919465 1000.1074369076086 ;
createNode camera -s -n "frontShape" -p "front";
	...
	setAttr ".ow" 0.68283833332320254;
...
createNode transform -n "imagePlane2";
	...
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" -7.814935058732579 -90 0 ;
	setAttr -l on ".rx";
	setAttr -l on ".ry";
	setAttr -l on ".rz";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C514BE6B-4959-A6F4-1856-99BF7FDD0FC6";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E157D408-4C8E-FDF6-5525-88AF12578919";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "30DCC038-4C57-29D3-1983-9DB1ABFFCC04";
createNode displayLayerManager -n "layerManager";
	rename -uid "F375C756-4830-1F77-F1EF-35974835AE36";
createNode displayLayer -n "defaultLayer";
	rename -uid "A9E7D67A-43C4-94EE-C24C-79A9A22B955B";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "329BAE7B-46B2-3E1F-A7E0-A3A7A4DD741B";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 1720 -ast 1 -aet 1720 ";
	setAttr ".st" 6;
...
createNode animCurveTA -n "DOF_01_Ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  30 23.567420314517992 80 23.567420314517992
		 145 23.567420314517992;
createNode animCurveTA -n "DOF_02_Ctrl_rotateZ";
	rename -uid "FC46CFCA-4C8E-60C0-99FC-7685A7C3A3C3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  30 -15.786787568426144 80 -15.786787568426144
		 145 -15.786787568426144;
createNode animCurveTA -n "DOF_03_Ctrl_rotateY";
	rename -uid "841C7404-48BC-187B-D973-1887E101021D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  30 -66.021253308855236 80 -66.021253308855236
		 145 -66.021253308855236;
createNode animCurveTA -n "DOF_04_Ctrl_rotateX";
	...
	setAttr -s 3 ".ktv[0:2]"  30 11.826418487149997 80 10.632149994412265
		 145 10.632149994412265;
createNode animCurveTA -n "DOF_05_Ctrl_rotateZ";
	rename -uid "A4EB9708-4DED-F996-7D3E-DDA088DA79C6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  30 -42.315798233407868 80 -42.315798233407868
		 145 -42.315798233407868;
createNode animCurveTA -n "DOF_06_Ctrl_rotateY";
	rename -uid "A276D6A9-46C8-CD25-DCA0-F9BA31B555B4";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  30 -78.074785288601177 80 -76.833804024347117
		 145 -76.833804024347117;
...
// End of simple_model_rigged_2nd_anim_test_02.ma
