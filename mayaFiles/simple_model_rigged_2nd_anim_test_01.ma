...
//Name: simple_model_rigged_2nd_anim_test_01.ma
//Last modified: Sun, Aug 18, 2019 01:30:10 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.47546289729491392 0.40057590623565814 0.95303537766398738 ;
	setAttr ".r" -type "double3" -14.738352729636162 -9.4000000000031303 -8.0596098421298642e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "7AAA6841-4C09-5833-F9E9-F7B1A9421867";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".ncp" 0.001;
	setAttr ".coi" 0.96616173090432456;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -7.9843046776340687 6.5620913375643033 7.0939197089945978 ;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" -0.14290023859707998 0.13870626203971934 1000.1067882954239 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "F56B004A-4C05-C15D-BDE6-83B5D0C10B1C";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".ncp" 0.001;
	setAttr ".coi" 1000.1067882954239;
	setAttr ".ow" 0.97877536153227429;
...
createNode transform -n "imagePlane1";
	...
	setAttr ".t" -type "double3" -1.1943251430458157 0.44713451771349766 -0.32074127448978895 ;
...
createNode reference -n "simple_model_rigged_05RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 0 -66.71608808311258088 0"
		2 "|simple_model_rigged_05:RIG|simple_model_rigged_05:Base_joint|simple_model_rigged_05:DOF_joint_01|simple_model_rigged_05:DOF_joint_02|simple_model_rigged_05:DOF_joint_03" 
		"rotateX" " -av"
		2 "|simple_model_rigged_05:RIG|simple_model_rigged_05:Base_joint|simple_model_rigged_05:DOF_joint_01|simple_model_rigged_05:DOF_joint_02|simple_model_rigged_05:DOF_joint_03" 
		"rotateY" " -av"
...
// End of simple_model_rigged_2nd_anim_test_01.ma
