...
//Name: final_model_rigged_ANIM_19.ma
//Last modified: Wed, Nov 04, 2020 02:49:45 PM
//Codeset: 1252
...
fileInfo "UUID" "EA5478F1-4F07-F8BC-BBA6-8A9ED48D7045";
...
createNode transform -s -n "persp" -p "locator1";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 63.705407743320272 72.334005201774346 215.22462238092467 ;
	setAttr ".r" -type "double3" -5.7383527277965545 2534.5999999988735 -4.7191905037071469e-16 ;
...
createNode camera -s -n "perspShape" -p "|locator1|persp";
	...
	setAttr ".ncp" 1;
	setAttr ".fcp" 1000;
	setAttr ".coi" 179.37894008965594;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 127.4626135921975 40.186792767413884 128.15481550539118 ;
	setAttr ".r" -type "double3" 0.26164728818482896 -1395.399999999808 -5.2346575498721343e-17 ;
...
createNode camera -s -n "perspShape" -p "|persp";
	...
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 173.58241230906935;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AE61AA6C-4240-BD3A-33F2-38ABFFD8368D";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F33C2684-44A8-6A43-EDEC-93B52E3EFA58";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "542AB198-4CE2-05B2-6C4D-70A92DD2E09F";
createNode displayLayerManager -n "layerManager";
	rename -uid "B51806BC-4E5B-3281-DA2F-B3A4CD5DB360";
	setAttr ".cdl" 1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F261FCE6-49B5-EC5B-8FD2-0AAB6A306E11";
...
// End of final_model_rigged_ANIM_19.ma
